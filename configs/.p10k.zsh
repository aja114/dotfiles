# Generated by Powerlevel10k configuration wizard on 2021-09-24 at 17:38 CEST.
...
() {
  ...
  # Alter context based on which machine I'm on                                                    
  if [[ $SLURM_JOB_NAME == "interact" ]]; then
      ContextExt=" - INTERACTIVE" 
  elif [[ $(hostname) == 'ch01sx'* ]]; then
      ContextExt=" - CLUSTER"
  fi                                       
